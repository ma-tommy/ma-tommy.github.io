(function () {
	...
	.kz-remote { text-align:center;}
        ...
        .slider.lazyloaded .slick-prev::before {
            content: "https://cdn.kaizenplatform.net/v2/attachments/000/357/765/0f5420a298a365fe668410b250d29e3947e0f3fe.png";
            display: block;
            opacity: 1;
...
$(".order-35549").append("<p class=\"kz-remote\"><img src=\"https://cdn.kaizenplatform.net/v2/attachments/000/357/752/a0b59c3a062298dfb6acf166add2f210b9f155c5.png\" alt=\"高品質インターネットでサクサク快適！\"></p>");
...
$(".featureBox_content > ul > li:eq(0)").append("<p><a href=\"#kz-01\" class=\"kz-link\">詳細を見る</a></p>");
$(".featureBox_content > ul > li:eq(1)").append("<p><a href=\"#kz-02\" class=\"kz-link\">詳細を見る</a></p>");
$(".featureBox_content > ul > li:eq(2)").append("<p><a href=\"#kz-03\" class=\"kz-link\">速度を確認する</a></p>");
$(".featureBox_content > ul > li:eq(3)").append("<p><a href=\"#kz-04\" class=\"kz-link\">詳細を見る</a></p>");
$(".featureBox_content > ul > li:eq(4)").append("<p><a href=\"#kz-05\" class=\"kz-link\">特典を見る</a></p>");

$(".order-35549 > .contents_wrapper > div:eq(0) > .box-order-net > a:eq(0) > img:eq(0)").attr({"src":"https://cdn.kaizenplatform.net/v2/attachments/000/357/763/cf1fe63ddaa1617dd89fb75294def14c6e781366.png","alt":"インターネットで簡単お申し込み", "data-src":"https://cdn.kaizenplatform.net/v2/attachments/000/357/763/cf1fe63ddaa1617dd89fb75294def14c6e781366.png"});
$(".order-35549 > .contents_wrapper > div:eq(0) > .box-order-done > a:eq(0) > img:eq(0)").attr({"src":"https://cdn.kaizenplatform.net/v2/attachments/000/357/766/e5f825d10140070f6419fe319c4c4e4bb6e70cf6.png","alt":"ドコモ光をご契約中のお客さま", "data-src":"https://cdn.kaizenplatform.net/v2/attachments/000/357/766/e5f825d10140070f6419fe319c4c4e4bb6e70cf6.png"});
$(".order-35549 > .contents_wrapper > div:eq(0) > p:eq(2) > a:eq(0) > img:eq(0)").removeAttr("width height");
$(".order-35549 > .contents_wrapper > div:eq(0) > p:eq(2) > a:eq(0) > img:eq(0)").attr({"src":"https://cdn.kaizenplatform.net/v2/attachments/000/357/765/0f5420a298a365fe668410b250d29e3947e0f3fe.png","alt":"電話で相談する", "data-src": "https://cdn.kaizenplatform.net/v2/attachments/000/357/765/0f5420a298a365fe668410b250d29e3947e0f3fe.png"});

$(".order-35549 > .contents_wrapper > div:eq(0) > .box-order-net").insertAfter(".order-35549 > .contents_wrapper > div:eq(0) > .box-order-done");
//ヘッダの高さ
var headerHight =
			$(".header_wrapper").height() +
			$(".gmoGroupHeader.gmoGroupHeader-keepdistance").height();
$(".kz-link").click(function (event) {
		var href = $(this).attr("href");
		var target = $(href == "#" || href == "" ? "html" : href);
		var position = target.offset().top - headerHight; //ヘッダの高さ分位置をずらす
